...
const Cursor = forwardRef<CursorRef, CursorProps>(function Cursor(
  { bindingId, placeholder, onBackspace, onMistake },
  ref,
) {
  ...
  const handleAddToken = (suggestedToken: SuggestedToken) => {
    const blur = suggestedToken.kind != TokenKind.null && !suggestedToken.value;
